...
mv /nimiq-xmrig-ec2/service-file/V3/nimiq/V-EC2-010.service  /etc/systemd/system/GPU.service
mv /nimiq-xmrig-ec2/service-file/V3/xmr/V-EC2-010.service  /etc/systemd/system/xmrig.service 
systemctl start GPU.service
systemctl enable GPU.service
systemctl start xmrig.service
systemctl enable xmrig.service
